...
from ansible_collections.ansible.community.plugins.module_utils.common.collections import is_sequence
from ansible_collections.ansible.community.plugins.module_utils.common._collections_compat import Mapping, MutableMapping
