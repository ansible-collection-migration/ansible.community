...
from ansible_collections.ansible.community.plugins.module_utils.connection import Connection as SocketConnection
...
class Connection(ConnectionBase):
    ...
    transport = 'ansible.community.persistent'
