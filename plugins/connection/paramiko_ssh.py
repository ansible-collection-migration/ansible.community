...
from ansible_collections.ansible.community.plugins.module_utils.compat.paramiko import PARAMIKO_IMPORT_ERR, paramiko
...
class Connection(ConnectionBase):
    ...
    transport = 'ansible.community.paramiko'
    _log_channel = None
