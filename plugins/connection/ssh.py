...
from ansible_collections.ansible.community.plugins.module_utils._text import to_bytes, to_native, to_text
from ansible_collections.ansible.community.plugins.module_utils.parsing.convert_bool import BOOLEANS, boolean
from ansible.plugins.connection import ConnectionBase, BUFSIZE
from ansible_collections.ansible.community.plugins.shell.powershell import _parse_clixml
...
class Connection(ConnectionBase):
    ...
    transport = 'ansible.community.ssh'
    has_pipelining = True
