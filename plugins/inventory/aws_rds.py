...
- ansible.community.inventory_cache
- ansible.community.constructed
- ansible.community.aws_credentials
'''
...
from ansible_collections.ansible.community.plugins.module_utils.aws.core import is_boto3_error_code
from ansible_collections.ansible.community.plugins.module_utils.ec2 import ansible_dict_to_boto3_filter_list, boto3_tag_list_to_ansible_dict
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    NAME = 'ansible.community.aws_rds'
