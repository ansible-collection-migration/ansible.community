...
from ansible_collections.ansible.community.plugins.module_utils.docker.common import update_tls_hostname, get_connect_params
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'ansible.community.docker_swarm'
