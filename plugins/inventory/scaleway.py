...
from ansible_collections.ansible.community.plugins.module_utils.scaleway import SCALEWAY_LOCATION, parse_pagination_link
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    NAME = 'ansible.community.scaleway'
