...
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.argspec.interfaces.interfaces import InterfacesArgs
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.utils.utils import get_interface_type
