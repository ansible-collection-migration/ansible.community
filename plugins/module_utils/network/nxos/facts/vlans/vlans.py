...
from ansible_collections.ansible.community.plugins.module_utils.network.common.utils import parse_conf_arg, parse_conf_cmd_arg
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.argspec.vlans.vlans import VlansArgs
