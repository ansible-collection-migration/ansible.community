...
from ansible_collections.ansible.community.plugins.module_utils.network.common.utils import remove_empties
from ansible_collections.ansible.community.plugins.module_utils.network.iosxr. \
