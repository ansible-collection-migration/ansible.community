...
from ansible_collections.ansible.community.plugins.module_utils.facts.virtual.base import Virtual, VirtualCollector
from ansible_collections.ansible.community.plugins.module_utils.facts.utils import get_file_content, get_file_lines
