...
from ansible_collections.ansible.community.plugins.module_utils.basic import to_native, to_bytes
from ansible_collections.ansible.community.plugins.module_utils.azure_rm_common import AzureRMModuleBase, azure_id_to_dict, normalize_location_name, format_resource_id
