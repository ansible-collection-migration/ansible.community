...
- ansible.community.VmwareRestModule.documentation
'''
...
from ansible_collections.ansible.community.plugins.module_utils.vmware_httpapi.VmwareRestModule import API, VmwareRestModule
