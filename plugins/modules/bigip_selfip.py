...
try:
    ...
    from ansible_collections.ansible.community.plugins.module_utils.network.f5.ipaddress import ipv6_netmask_to_cidr
    from ansible_collections.ansible.community.plugins.module_utils.compat.ipaddress import ip_address
