...
- ansible.community.k8s_name_options
- ansible.community.k8s_auth_options
- ansible.community.k8s_resource_options
- ansible.community.k8s_scale_options
'''
...
from ansible_collections.ansible.community.plugins.module_utils.k8s.scale import KubernetesAnsibleScaleModule
