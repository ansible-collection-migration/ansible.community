...
- ansible.community.checkpoint_facts
'''
...
from ansible_collections.ansible.community.plugins.module_utils.network.checkpoint.checkpoint import checkpoint_argument_spec_for_facts, api_call_facts_for_rule
