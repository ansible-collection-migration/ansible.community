...
from ansible_collections.ansible.community.plugins.module_utils.api import basic_auth_argument_spec
...
from ansible_collections.ansible.community.plugins.module_utils.gitlab import findGroup, findProject, gitlabAuthentication
