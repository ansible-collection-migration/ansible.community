...
- ansible.community.netconf
- ansible.community.network_agnostic
'''
...
from ansible_collections.ansible.community.plugins.module_utils.network.netconf.netconf import get_capabilities, get_config, sanitize_xml
