...
try:
    ...
    from ansible_collections.ansible.community.plugins.module_utils.compat.ipaddress import ip_network
    from ansible_collections.ansible.community.plugins.module_utils.compat.ipaddress import ip_interface
