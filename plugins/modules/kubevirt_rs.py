...
- ansible.community.kubevirt_vm_options
- ansible.community.kubevirt_common_options
'''
...
from ansible_collections.ansible.community.plugins.module_utils.kubevirt import (
    virtdict,
    KubeVirtRawModule,
    VM_COMMON_ARG_SPEC,
)
