...
from ansible_collections.ansible.community.plugins.module_utils.network.common.network import NetworkModule, NetworkError
from ansible_collections.ansible.community.plugins.module_utils.network.common.config import NetworkConfig, dumps
from ansible_collections.ansible.community.plugins.module_utils.network.common.parsing import Command
from ansible_collections.ansible.community.plugins.module_utils.network.ordnance.ordnance import get_config
