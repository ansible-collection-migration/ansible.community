...
from ansible_collections.ansible.community.plugins.module_utils.connection import exec_command
...
from ansible_collections.ansible.community.plugins.module_utils.network.cnos.cnos import debugOutput, check_args
