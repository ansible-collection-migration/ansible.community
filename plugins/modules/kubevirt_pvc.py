...
- ansible.community.k8s_auth_options
'''
...
from ansible_collections.ansible.community.plugins.module_utils.k8s.common import AUTH_ARG_SPEC
from ansible_collections.ansible.community.plugins.module_utils.k8s.raw import KubernetesRawModule
from ansible_collections.ansible.community.plugins.module_utils.kubevirt import virtdict, KubeVirtRawModule
