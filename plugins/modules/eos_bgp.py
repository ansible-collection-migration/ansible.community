...
from ansible_collections.ansible.community.plugins.module_utils.network.eos.providers.module import NetworkModule
from ansible_collections.ansible.community.plugins.module_utils.network.eos.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
