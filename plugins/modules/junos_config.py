...
from ansible_collections.ansible.community.plugins.module_utils.network.junos.junos import get_diff, load_config, get_configuration
from ansible_collections.ansible.community.plugins.module_utils.network.junos.junos import commit_configuration, discard_changes, locked_config
from ansible_collections.ansible.community.plugins.module_utils.network.junos.junos import junos_argument_spec, load_configuration, tostring
from ansible.module_utils.six import string_types
from ansible_collections.ansible.community.plugins.module_utils._text import to_native, to_text
