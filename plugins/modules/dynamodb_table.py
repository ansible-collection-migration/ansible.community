...
try:
    import botocore
    from ansible_collections.ansible.community.plugins.module_utils.ec2 import ansible_dict_to_boto3_tag_list, boto3_conn
    HAS_BOTO3 = True
except ImportError:
    HAS_BOTO3 = False

from ansible_collections.ansible.community.plugins.module_utils.basic import AnsibleModule
from ansible_collections.ansible.community.plugins.module_utils.ec2 import AnsibleAWSError, connect_to_aws, ec2_argument_spec, get_aws_connection_info
