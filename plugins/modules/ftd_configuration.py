...
from ansible_collections.ansible.community.plugins.module_utils.network.ftd.configuration import BaseConfigurationResource, CheckModeException, \
...
from ansible_collections.ansible.community.plugins.module_utils.network.ftd.common import construct_ansible_facts, FtdConfigurationError, \
