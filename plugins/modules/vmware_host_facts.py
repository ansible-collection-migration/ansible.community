...
from ansible_collections.ansible.community.plugins.module_utils.vmware import PyVmomi, vmware_argument_spec, find_obj
...
from ansible_collections.ansible.community.plugins.module_utils.vmware_rest_client import VmwareRestClient
