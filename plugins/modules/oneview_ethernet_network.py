...
- ansible.community.oneview
- ansible.community.oneview.validateetag
'''
...
from ansible_collections.ansible.community.plugins.module_utils.oneview import OneViewModuleBase, OneViewModuleResourceNotFound
