...
- ansible.community.netapp.eseries
'''
EXAMPLES = """
...
from ansible_collections.ansible.community.plugins.module_utils.netapp import NetAppESeriesModule, create_multipart_formdata, request
