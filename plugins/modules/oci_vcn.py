...
- ansible.community.oracle
- ansible.community.oracle_creatable_resource
- ansible.community.oracle_wait_options
- ansible.community.oracle_tags
'''
...
from ansible_collections.ansible.community.plugins.module_utils.oracle import oci_utils
