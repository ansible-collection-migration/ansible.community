...
from ansible_collections.ansible.community.plugins.module_utils.network.common.utils import remove_default_spec
...
try:
    ...
    from ansible_collections.ansible.community.plugins.module_utils.network.f5.common import is_valid_hostname
    ...
    from ansible_collections.ansible.community.plugins.module_utils.network.f5.icontrol import TransactionContextManager
