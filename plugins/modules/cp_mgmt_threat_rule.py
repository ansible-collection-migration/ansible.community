...
- ansible.community.checkpoint_objects
'''
...
from ansible_collections.ansible.community.plugins.module_utils.network.checkpoint.checkpoint import checkpoint_argument_spec_for_objects, api_call, api_call_for_rule
