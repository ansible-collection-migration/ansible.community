...
class TestImports(ModuleTestCase):
    ...
    def test_module_utils_basic_import_syslog(self, mock_import):
        ...
        self.clear_modules(['syslog', 'ansible_collections.ansible.community.plugins.module_utils.basic'])
        mod = builtins.__import__('ansible_collections.ansible.community.plugins.module_utils.basic')
    ...
    def test_module_utils_basic_import_selinux(self, mock_import):
        ...
        try:
            self.clear_modules(['selinux', 'ansible_collections.ansible.community.plugins.module_utils.basic'])
            mod = builtins.__import__('ansible_collections.ansible.community.plugins.module_utils.basic')
    ...
    def test_module_utils_basic_import_json(self, mock_import):
        def _mock_import(name, *args, **kwargs):
            if name == 'ansible_collections.ansible.community.plugins.module_utils.common._json_compat':
                raise ImportError
            return realimport(name, *args, **kwargs)

        self.clear_modules(['json', 'ansible_collections.ansible.community.plugins.module_utils.basic'])
        builtins.__import__('ansible_collections.ansible.community.plugins.module_utils.basic')
        self.clear_modules(['json', 'ansible_collections.ansible.community.plugins.module_utils.basic'])
        mock_import.side_effect = _mock_import
    ...
    def test_module_utils_basic_import_literal_eval(self, mock_import):
        ...
        mock_import.side_effect = _mock_import
        self.clear_modules(['ast', 'ansible_collections.ansible.community.plugins.module_utils.basic'])
        mod = builtins.__import__('ansible_collections.ansible.community.plugins.module_utils.basic')
    ...
    def test_module_utils_basic_import_systemd_journal(self, mock_import):
        ...
        self.clear_modules(['systemd', 'ansible_collections.ansible.community.plugins.module_utils.basic'])
        mod = builtins.__import__('ansible_collections.ansible.community.plugins.module_utils.basic')
