...
def mock_os(mocker):
    ...
    os = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.os')
    os._cmd_out = {
...
def mock_subprocess(mocker):
    ...
    fake_select = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.select')
    fake_select.select.side_effect = mock_select

    subprocess = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.subprocess')
...
def test_run_command_fds(mocker, rc_am):
    subprocess_mock = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.subprocess')
