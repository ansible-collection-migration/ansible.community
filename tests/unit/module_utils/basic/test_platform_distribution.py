...
from ansible_collections.ansible.community.plugins.module_utils.basic import get_platform
from ansible_collections.ansible.community.plugins.module_utils.basic import get_all_subclasses
from ansible_collections.ansible.community.plugins.module_utils.basic import get_distribution
from ansible_collections.ansible.community.plugins.module_utils.basic import get_distribution_version
from ansible_collections.ansible.community.plugins.module_utils.basic import load_platform_subclass
...
class TestLoadPlatformSubclass:
    ...
    def test_not_linux(self):
        ...
        with patch('platform.system', return_value="Foo"):
            with patch('ansible_collections.ansible.community.plugins.module_utils.common.sys_info.get_distribution', return_value=None):
    ...
    def test_get_distribution_found(self):
        ...
        with patch('ansible_collections.ansible.community.plugins.module_utils.common.sys_info.get_distribution', return_value="Bar"):
