...
from ansible_collections.ansible.community.plugins.module_utils.urls import fetch_url, urllib_error, ConnectionError, NoSSLError, httplib
...
def open_url_mock(mocker):
    return mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.open_url')
...
def test_fetch_url_no_urlparse(mocker, fake_ansible_module):
    mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.HAS_URLPARSE', new=False)
...
def test_fetch_url_cookies(mocker, fake_ansible_module):
    ...
    mocker = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.open_url', new=make_cookies)
...
def test_fetch_url_nossl(open_url_mock, fake_ansible_module, mocker):
    mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.get_distribution', return_value='notredhat')
    ...
    mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.get_distribution', return_value='redhat')
