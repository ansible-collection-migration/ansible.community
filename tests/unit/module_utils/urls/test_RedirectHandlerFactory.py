...
from ansible_collections.ansible.community.plugins.module_utils.urls import HAS_SSLCONTEXT, RedirectHandlerFactory, urllib_request, urllib_error
...
def test_all_redir(urllib_req, request_body, mocker):
    req_mock = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.RequestWithMethod')
...
def test_redir_validate_certs(urllib_req, request_body, mocker):
    opener_mock = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.urls.urllib_request._opener')
