...
from ansible_collections.ansible.community.plugins.module_utils.facts import timeout

from ansible_collections.ansible.community.plugins.module_utils.facts.hardware import linux
...
class TestFactsLinuxHardwareGetMountFacts(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._mtab_entries', return_value=MTAB_ENTRIES)
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._find_bind_mounts', return_value=BIND_MOUNTS)
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._lsblk_uuid', return_value=LSBLK_UUIDS)
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.get_mount_size', side_effect=mock_get_mount_size)
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._udevadm_uuid', return_value=UDEVADM_UUID)
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.get_file_content', return_value=MTAB)
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._run_findmnt', return_value=(0, FINDMNT_OUTPUT, ''))
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._run_findmnt', return_value=(37, '', ''))
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(0, LSBLK_OUTPUT, ''))
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(37, LSBLK_OUTPUT, ''))
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(0, LSBLK_OUTPUT_2, ''))
