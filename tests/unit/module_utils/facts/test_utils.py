...
from ansible_collections.ansible.community.plugins.module_utils.facts import utils
...
class TestGetMountSize(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.utils.os.statvfs', side_effect=OSError('intentionally induced os error'))
