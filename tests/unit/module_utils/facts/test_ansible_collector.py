...
from ansible_collections.ansible.community.plugins.module_utils.facts import namespace
...
from ansible_collections.ansible.community.plugins.module_utils.facts.system.pkg_mgr import PkgMgrFactCollector, OpenBSDPkgMgrFactCollector
...
class TestCollectedFacts(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.system.service_mgr.get_file_content', return_value='systemd')
