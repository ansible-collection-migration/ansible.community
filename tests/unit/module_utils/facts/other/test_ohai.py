...
class TestOhaiCollector(BaseFactsTest):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.other.ohai.OhaiFactCollector.get_ohai_output')
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.other.ohai.OhaiFactCollector.run_ohai')
