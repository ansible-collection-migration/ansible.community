...
class TestFacterCollector(BaseFactsTest):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.other.facter.FacterFactCollector.get_facter_output')
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.facts.other.facter.FacterFactCollector.run_facter')
