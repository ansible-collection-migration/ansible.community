...
from ansible_collections.ansible.community.plugins.module_utils.facts.network import iscsi
...
def test_get_iscsi_info(mocker):
    ...
    mocker.patch('ansible_collections.ansible.community.plugins.module_utils.facts.network.iscsi.get_bin_path', return_value='/usr/sbin/lsattr')
    ...
    mocker.patch('ansible_collections.ansible.community.plugins.module_utils.facts.network.iscsi.get_bin_path', return_value='/opt/iscsi/bin/iscsiutil')
