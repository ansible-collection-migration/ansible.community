...
def stdin(mocker, request):
    ...
    if PY3:
        mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.sys.stdin', mocker.MagicMock())
        mocker.patch('ansible.module_utils.basic.sys.stdin.buffer', fake_stdin)
    else:
        mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.sys.stdin', fake_stdin)
