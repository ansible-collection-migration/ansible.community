...
from ansible_collections.ansible.community.tests.unit.compat.mock import call, patch

from ansible_collections.ansible.community.plugins.module_utils.network.ftd.common import HTTPMethod, FtdUnexpectedResponse
from ansible_collections.ansible.community.plugins.module_utils.network.ftd.configuration import iterate_over_pageable_resource, BaseConfigurationResource, \
    OperationChecker, OperationNamePrefix, ParamName, QueryParams
from ansible_collections.ansible.community.plugins.module_utils.network.ftd.fdm_swagger_client import ValidationError, OperationField
