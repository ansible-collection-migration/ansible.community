...
from ansible_collections.ansible.community.plugins.module_utils.network.nso import nso
...
class TestJsonRpc(unittest.TestCase):
    @patch('ansible_collections.ansible.community.plugins.module_utils.network.nso.nso.open_url')
