...
from ansible_collections.ansible.community.plugins.module_utils.network.nos import nos
...
class TestPluginCLIConfNOS(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.network.nos.nos.Connection')
