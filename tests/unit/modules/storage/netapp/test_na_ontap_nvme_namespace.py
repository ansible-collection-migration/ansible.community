...
from ansible_collections.ansible.community.plugins.modules.na_ontap_nvme_namespace \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_nvme_namespace.NetAppONTAPNVMENamespace.create_namespace')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_nvme_namespace.NetAppONTAPNVMENamespace.delete_namespace')
