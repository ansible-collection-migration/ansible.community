...
from ansible_collections.ansible.community.plugins.modules.na_ontap_dns \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.netapp.OntapRestAPI.send_request')
