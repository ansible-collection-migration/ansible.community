...
from ansible_collections.ansible.community.plugins.modules.netapp_e_iscsi_target import IscsiTarget
...
class IscsiTargetTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_iscsi_target.request'
