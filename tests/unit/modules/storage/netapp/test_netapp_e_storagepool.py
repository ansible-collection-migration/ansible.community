...
from ansible_collections.ansible.community.plugins.modules.netapp_e_storagepool import NetAppESeriesStoragePool
...
class StoragePoolTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_storagepool.request'
    NETAPP_REQUEST_FUNC = 'ansible_collections.ansible.community.plugins.module_utils.netapp.NetAppESeriesModule.request'
    VALIDATE_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_storagepool.NetAppESeriesModule.validate_instance'

    DRIVES_PROPERTY = 'ansible_collections.ansible.community.plugins.modules.netapp_e_storagepool.NetAppESeriesStoragePool.drives'
    STORAGE_POOL_PROPERTY = 'ansible_collections.ansible.community.plugins.modules.netapp_e_storagepool.NetAppESeriesStoragePool.storage_pool'
