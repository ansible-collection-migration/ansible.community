...
from ansible_collections.ansible.community.plugins.modules.na_ontap_service_processor_network \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_service_processor_network.NetAppOntapServiceProcessorNetwork.'
