...
from ansible_collections.ansible.community.plugins.modules.netapp_e_mgmt_interface import MgmtInterface
...
class MgmtInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_mgmt_interface.request'
