...
from ansible_collections.ansible.community.plugins.modules.netapp_e_alerts import Alerts
...
class AlertsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_alerts.request'
