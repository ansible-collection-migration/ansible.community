...
from ansible_collections.ansible.community.plugins.modules.na_ontap_kerberos_realm \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_kerberos_realm.NetAppOntapKerberosRealm.delete_krbrealm')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_kerberos_realm.NetAppOntapKerberosRealm.create_krbrealm')
