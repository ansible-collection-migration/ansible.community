...
from ansible_collections.ansible.community.plugins.modules.netapp_e_facts import Facts
...
class FactsTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_facts.Facts.request'
    GET_CONTROLLERS_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_facts.Facts.get_controllers'
