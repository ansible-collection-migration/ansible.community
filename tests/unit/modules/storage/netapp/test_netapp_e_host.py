...
from ansible_collections.ansible.community.plugins.modules.netapp_e_host import Host
...
class HostTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_host.request'
