...
from ansible_collections.ansible.community.plugins.modules.netapp_e_asup import Asup
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_asup.request'
