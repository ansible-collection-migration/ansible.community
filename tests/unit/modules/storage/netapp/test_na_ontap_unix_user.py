...
from ansible_collections.ansible.community.plugins.modules.na_ontap_unix_user \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.create_unix_user')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.modify_unix_user')
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.delete_unix_user')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.get_unix_user')
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.modify_unix_user')
