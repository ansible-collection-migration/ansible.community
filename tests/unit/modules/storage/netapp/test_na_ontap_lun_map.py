...
from ansible_collections.ansible.community.plugins.modules.na_ontap_lun_map \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_lun_map.NetAppOntapLUNMap.create_lun_map')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_lun_map.NetAppOntapLUNMap.delete_lun_map')
