...
from ansible_collections.ansible.community.plugins.module_utils.netapp import NetAppESeriesModule
from ansible_collections.ansible.community.plugins.modules.netapp_e_volume import NetAppESeriesVolume
from ansible_collections.ansible.community.tests.unit.modules.utils import AnsibleFailJson, ModuleTestCase, set_module_args
...
class NetAppESeriesVolumeTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_volume.NetAppESeriesVolume.request'
    GET_VOLUME_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_volume.NetAppESeriesVolume.get_volume'
    SLEEP_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_volume.sleep'
