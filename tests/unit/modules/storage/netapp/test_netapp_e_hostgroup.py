...
from ansible_collections.ansible.community.plugins.modules.netapp_e_hostgroup import NetAppESeriesHostGroup
...
class HostTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "rw",
                       ...
                       "ssid": "1"}
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_hostgroup.NetAppESeriesHostGroup.request'
    HOSTS_GET_RESPONSE = [
