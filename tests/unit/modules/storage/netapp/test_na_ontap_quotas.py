...
from ansible_collections.ansible.community.plugins.modules.na_ontap_quotas \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_set')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_delete')
