...
from ansible_collections.ansible.community.plugins.modules.netapp_e_ldap import Ldap
from ansible_collections.ansible.community.tests.unit.modules.utils import ModuleTestCase, set_module_args, AnsibleFailJson, AnsibleExitJson
...
class LdapTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_ldap.request'
