...
from ansible_collections.ansible.community.plugins.modules.na_ontap_volume_clone \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_volume_clone.NetAppONTAPVolumeClone.create_volume_clone')
