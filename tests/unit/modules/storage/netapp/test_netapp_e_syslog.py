...
from ansible_collections.ansible.community.plugins.modules.netapp_e_syslog import Syslog
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_syslog.request'
