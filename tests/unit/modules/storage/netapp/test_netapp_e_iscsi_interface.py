...
from ansible_collections.ansible.community.plugins.modules.netapp_e_iscsi_interface import IscsiInterface
...
class IscsiInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_iscsi_interface.request'
