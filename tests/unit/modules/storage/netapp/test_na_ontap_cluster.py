...
from ansible_collections.ansible.community.plugins.modules.na_ontap_cluster \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_cluster.NetAppONTAPCluster.create_cluster')
