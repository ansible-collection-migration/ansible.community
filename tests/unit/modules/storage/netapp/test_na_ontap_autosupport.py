...
from ansible_collections.ansible.community.plugins.modules.na_ontap_autosupport \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_autosupport.NetAppONTAPasup.get_autosupport_config')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_autosupport.NetAppONTAPasup.modify_autosupport_config')
