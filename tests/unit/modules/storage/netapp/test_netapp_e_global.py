...
from ansible_collections.ansible.community.plugins.modules.netapp_e_global import GlobalSettings
...
class GlobalSettingsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.ansible.community.plugins.modules.netapp_e_global.request'
