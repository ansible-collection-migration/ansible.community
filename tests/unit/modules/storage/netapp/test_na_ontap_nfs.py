...
from ansible_collections.ansible.community.plugins.modules.na_ontap_nfs \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_nfs.NetAppONTAPNFS.delete_nfs')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_nfs.NetAppONTAPNFS.get_nfs_service')
