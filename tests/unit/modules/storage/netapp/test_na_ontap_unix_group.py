...
from ansible_collections.ansible.community.plugins.modules.na_ontap_unix_group \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.create_unix_group')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.modify_unix_group')
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.delete_unix_group')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.get_unix_group')
    @patch('ansible_collections.ansible.community.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.modify_unix_group')
