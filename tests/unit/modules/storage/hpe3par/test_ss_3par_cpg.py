...
from ansible_collections.ansible.community.plugins.modules import ss_3par_cpg
from ansible_collections.ansible.community.plugins.module_utils.storage.hpe3par import hpe3par


@mock.patch('ansible_collections.ansible.community.plugins.modules.ss_3par_cpg.client')
@mock.patch('ansible_collections.ansible.community.plugins.modules.ss_3par_cpg.AnsibleModule')
@mock.patch('ansible_collections.ansible.community.plugins.modules.ss_3par_cpg.create_cpg')
...
@mock.patch('ansible_collections.ansible.community.plugins.modules.ss_3par_cpg.client')
@mock.patch('ansible_collections.ansible.community.plugins.modules.ss_3par_cpg.AnsibleModule')
@mock.patch('ansible_collections.ansible.community.plugins.modules.ss_3par_cpg.delete_cpg')
