...
from ansible_collections.ansible.community.plugins.modules import rabbitmq_user
...
class TestRabbitMQUserModule(ModuleTestCase):
    ...
    def test_permissions_with_same_vhost(self):
        ...
        with patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.get_bin_path') as get_bin_path:
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.get_bin_path')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.get')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.check_password')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.has_tags_modifications')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.has_permissions_modifications')
    ...
    @patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.get_bin_path')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser._exec')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser._get_permissions')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.has_tags_modifications')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser._exec')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser._get_permissions')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.set_permissions')
    @patch('ansible_collections.ansible.community.plugins.modules.rabbitmq_user.RabbitMqUser.has_tags_modifications')
