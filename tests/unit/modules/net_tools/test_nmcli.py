...
from ansible_collections.ansible.community.plugins.modules import nmcli
...
def mocker_set(mocker, connection_exists=False):
    ...
    """
    mocker.patch('ansible_collections.ansible.community.plugins.modules.nmcli.HAVE_DBUS', True)
    mocker.patch('ansible_collections.ansible.community.plugins.modules.nmcli.HAVE_NM_CLIENT', True)
    get_bin_path = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.get_bin_path')
