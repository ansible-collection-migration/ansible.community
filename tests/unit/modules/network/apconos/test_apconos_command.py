...
from ansible_collections.ansible.community.plugins.modules import apconos_command
...
class TestApconosCommandModule(TestApconosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.apconos_command.run_commands')
