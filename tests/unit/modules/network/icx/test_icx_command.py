...
from ansible_collections.ansible.community.plugins.modules import icx_command
...
class TestICXCommandModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.icx_command.run_commands')
