...
from ansible_collections.ansible.community.plugins.modules import icx_config
from ansible_collections.ansible.community.plugins.cliconf.icx import Cliconf
...
class TestICXConfigModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.icx_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('ansible_collections.ansible.community.plugins.modules.icx_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.icx_config.run_commands')
