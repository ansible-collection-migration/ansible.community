...
from ansible_collections.ansible.community.plugins.modules import icx_interface
...
class TestICXInterfaceModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.ansible.community.plugins.modules.icx_interface.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.icx_interface.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.icx_interface.get_config')
