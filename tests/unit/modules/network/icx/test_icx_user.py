...
from ansible_collections.ansible.community.plugins.modules import icx_user
...
class TestICXSCPModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.icx_user.get_config')
        self.get_config = self.mock_get_config.start()
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.icx_user.load_config')
        self.load_config = self.mock_load_config.start()
        self.mock_exec_command = patch('ansible_collections.ansible.community.plugins.modules.icx_user.exec_command')
