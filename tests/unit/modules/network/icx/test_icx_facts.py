...
from ansible_collections.ansible.community.plugins.modules import icx_facts
...
class TestICXFactsModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.icx_facts.run_commands')
