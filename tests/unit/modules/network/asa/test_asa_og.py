...
from ansible_collections.ansible.community.plugins.modules import asa_og
...
class TestAsaOgModule(TestAsaModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.asa_og.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.asa_og.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_connection = patch('ansible_collections.ansible.community.plugins.module_utils.network.asa.asa.get_connection')
