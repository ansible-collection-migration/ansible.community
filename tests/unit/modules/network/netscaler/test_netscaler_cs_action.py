...
class TestNetscalerCSActionModule(TestModule):
    ...
    def test_graceful_nitro_api_import_error(self):
        ...
        self.nitro_base_patcher.stop()
        self.nitro_specific_patcher.stop()
        from ansible_collections.ansible.community.plugins.modules import netscaler_cs_action
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.community.plugins.modules.netscaler_cs_action.get_nitro_client', m):
            with patch('ansible_collections.ansible.community.plugins.modules.netscaler_cs_action.nitro_exception', MockException):
                self.module = netscaler_cs_action
                result = self.failed()
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'ansible_collections.ansible.community.plugins.modules.netscaler_cs_action',
            get_nitro_client=m,
