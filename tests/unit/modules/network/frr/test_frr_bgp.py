...
from ansible_collections.ansible.community.plugins.module_utils.network.frr.providers.cli.config.bgp.process import Provider
from ansible_collections.ansible.community.plugins.modules import frr_bgp
