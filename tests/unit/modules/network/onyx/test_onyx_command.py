...
from ansible_collections.ansible.community.plugins.modules import onyx_command
...
class TestOnyxCommandModule(TestOnyxModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.ansible.community.plugins.modules.onyx_command.run_commands')
