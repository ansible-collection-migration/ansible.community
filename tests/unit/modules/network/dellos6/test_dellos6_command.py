...
from ansible_collections.ansible.community.plugins.modules import dellos6_command
...
class TestDellos6CommandModule(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.dellos6_command.run_commands')
