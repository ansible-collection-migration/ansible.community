...
from ansible_collections.ansible.community.plugins.modules import dellos6_facts
...
class TestDellos6Facts(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.ansible.community.plugins.modules.dellos6_facts.run_commands')
