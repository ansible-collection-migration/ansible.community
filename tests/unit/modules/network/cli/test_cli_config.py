...
from ansible_collections.ansible.community.plugins.modules import cli_config
...
class TestCliConfigModule(TestCliModule):
    ...
    def setUp(self):
        ...
        self.mock_connection = patch('ansible_collections.ansible.community.plugins.modules.cli_config.Connection')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.cli_config.run')
