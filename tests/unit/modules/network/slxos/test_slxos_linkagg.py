...
from ansible_collections.ansible.community.plugins.modules import slxos_linkagg
...
class TestSlxosLinkaggModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.ansible.community.plugins.modules.slxos_linkagg.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.ansible.community.plugins.modules.slxos_linkagg.load_config'
        )
