...
from ansible_collections.ansible.community.plugins.modules import vyos_static_route
...
class TestVyosStaticRouteModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_static_route.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_static_route.load_config')
