...
from ansible_collections.ansible.community.plugins.modules import vyos_config
from ansible_collections.ansible.community.plugins.cliconf.vyos import Cliconf
...
class TestVyosConfigModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.vyos_config.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_get_connection = patch('ansible_collections.ansible.community.plugins.modules.vyos_config.get_connection')
