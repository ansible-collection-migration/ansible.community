...
from ansible_collections.ansible.community.plugins.modules import vyos_facts
...
class TestVyosFactsModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.module_utils.network.vyos.facts.legacy.base.run_commands')
        ...
        self.mock_get_capabilities = patch('ansible_collections.ansible.community.plugins.module_utils.network.vyos.facts.legacy.base.get_capabilities')
