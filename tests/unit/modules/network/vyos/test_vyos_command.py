...
from ansible_collections.ansible.community.plugins.modules import vyos_command
...
class TestVyosCommandModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.vyos_command.run_commands')
