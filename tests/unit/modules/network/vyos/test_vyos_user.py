...
from ansible_collections.ansible.community.plugins.modules import vyos_user
...
class TestVyosUserModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_user.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_user.load_config')
