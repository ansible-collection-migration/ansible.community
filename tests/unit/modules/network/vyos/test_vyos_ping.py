...
from ansible_collections.ansible.community.plugins.modules import vyos_ping
...
class TestVyosPingModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.vyos_ping.run_commands')
