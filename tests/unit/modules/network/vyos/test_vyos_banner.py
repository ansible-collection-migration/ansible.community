...
from ansible_collections.ansible.community.plugins.modules import vyos_banner
...
class TestVyosBannerModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_banner.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.vyos_banner.load_config')
