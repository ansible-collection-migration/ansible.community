...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_service_tcp
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_service_tcp.api_call'
