...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_dns_domain
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_dns_domain.api_call'
