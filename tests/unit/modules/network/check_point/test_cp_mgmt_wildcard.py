...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_wildcard
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_wildcard.api_call'
