...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_host
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_host.api_call'
