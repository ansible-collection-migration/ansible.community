...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_time
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_time.api_call'
