...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_threat_layer
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_threat_layer.api_call'
