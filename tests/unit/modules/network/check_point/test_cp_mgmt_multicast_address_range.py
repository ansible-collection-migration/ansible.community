...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_multicast_address_range
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_multicast_address_range.api_call'
