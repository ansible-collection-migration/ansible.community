...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_vpn_community_star
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_vpn_community_star.api_call'
