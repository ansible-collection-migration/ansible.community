...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_group
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_group.api_call'
