...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_exception_group
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_exception_group.api_call'
