...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_application_site
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_application_site.api_call'
