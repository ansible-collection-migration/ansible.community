...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_application_site_category
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_application_site_category.api_call'
...
class TestCheckpointApplicationSiteCategory(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.module_utils.network.checkpoint.checkpoint.Connection')
