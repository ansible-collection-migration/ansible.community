...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_dynamic_object
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_dynamic_object.api_call'
