...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_global_assignment
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_global_assignment.api_call'
