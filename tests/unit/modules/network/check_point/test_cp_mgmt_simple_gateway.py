...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_simple_gateway
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_simple_gateway.api_call'
