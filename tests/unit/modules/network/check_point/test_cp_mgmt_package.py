...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_package
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_package.api_call'
