...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_vpn_community_meshed
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_vpn_community_meshed.api_call'
