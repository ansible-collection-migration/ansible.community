...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_access_rule
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_access_rule.api_call'
