...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_service_icmp
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_service_icmp.api_call'
