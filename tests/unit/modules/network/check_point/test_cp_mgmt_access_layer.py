...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_access_layer
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_access_layer.api_call'
