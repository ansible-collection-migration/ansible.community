...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_application_site_group
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_application_site_group.api_call'
