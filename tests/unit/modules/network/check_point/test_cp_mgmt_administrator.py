...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_administrator
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_administrator.api_call'
