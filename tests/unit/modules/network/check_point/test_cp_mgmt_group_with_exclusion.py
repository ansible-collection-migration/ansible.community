...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_group_with_exclusion
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_group_with_exclusion.api_call'
