...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_network
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_network.api_call'
