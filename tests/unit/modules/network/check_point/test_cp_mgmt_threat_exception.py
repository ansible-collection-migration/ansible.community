...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_threat_exception
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_threat_exception.api_call'
