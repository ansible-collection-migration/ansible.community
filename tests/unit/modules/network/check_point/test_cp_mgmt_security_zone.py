...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_security_zone
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_security_zone.api_call'
