...
from ansible_collections.ansible.community.plugins.modules import cp_mgmt_access_role
...
function_path = 'ansible_collections.ansible.community.plugins.modules.cp_mgmt_access_role.api_call'
