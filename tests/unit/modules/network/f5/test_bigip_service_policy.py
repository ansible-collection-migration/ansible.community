...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_service_policy import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_service_policy import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_service_policy import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_service_policy import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_service_policy.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
