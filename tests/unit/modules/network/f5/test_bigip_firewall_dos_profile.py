...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_dos_profile import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_dos_profile import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_dos_profile import ArgumentSpec
