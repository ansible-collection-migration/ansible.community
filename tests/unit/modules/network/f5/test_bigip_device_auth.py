...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_device_auth import TacacsApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_auth import TacacsModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_auth import TacacsManager
    from ansible_collections.ansible.community.plugins.modules.bigip_device_auth import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_device_auth import ArgumentSpec
