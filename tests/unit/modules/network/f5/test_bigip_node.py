...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_node import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_node import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_node import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_node import ArgumentSpec
