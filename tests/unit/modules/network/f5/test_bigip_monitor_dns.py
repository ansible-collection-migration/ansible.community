...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_dns import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_dns import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_dns import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_dns import ArgumentSpec
