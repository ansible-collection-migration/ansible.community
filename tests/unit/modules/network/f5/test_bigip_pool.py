...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_pool import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_pool import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_pool import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_pool import ArgumentSpec
