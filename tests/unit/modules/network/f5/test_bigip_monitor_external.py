...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_external import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_external import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_external import ArgumentSpec
