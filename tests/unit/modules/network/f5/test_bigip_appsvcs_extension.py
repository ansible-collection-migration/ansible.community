...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_appsvcs_extension import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_appsvcs_extension import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_appsvcs_extension import ArgumentSpec
