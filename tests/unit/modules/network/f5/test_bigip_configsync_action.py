...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_configsync_action import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_configsync_action import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_configsync_action import ArgumentSpec
