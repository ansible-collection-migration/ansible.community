...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_irule import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_irule import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_irule import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_irule import GtmManager
    from ansible_collections.ansible.community.plugins.modules.bigip_irule import LtmManager

    # Ansible 2.8 imports
    from ansible_collections.ansible.community.tests.unit.compat import unittest
    from ansible_collections.ansible.community.tests.unit.compat.mock import Mock
    from ansible_collections.ansible.community.tests.unit.compat.mock import patch
    from ansible_collections.ansible.community.tests.unit.compat.mock import mock_open
...
class TestManager(unittest.TestCase):
    ...
    def test_module_mutual_exclusion(self, *args):
        ...
        with patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.fail_json', unsafe=True) as mo:
            AnsibleModule(
                argument_spec=self.spec.argument_spec,
                supports_check_mode=self.spec.supports_check_mode,
                mutually_exclusive=self.spec.mutually_exclusive,
