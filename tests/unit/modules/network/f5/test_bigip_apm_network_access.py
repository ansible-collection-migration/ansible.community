...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_apm_network_access import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_apm_network_access import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_apm_network_access import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_apm_network_access import ArgumentSpec
