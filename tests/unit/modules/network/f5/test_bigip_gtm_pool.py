...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool import UntypedManager
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool import TypedManager
...
class TestUntypedManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_gtm_pool.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
