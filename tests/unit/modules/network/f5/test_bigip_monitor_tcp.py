...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_tcp import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_tcp import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_tcp import ArgumentSpec
