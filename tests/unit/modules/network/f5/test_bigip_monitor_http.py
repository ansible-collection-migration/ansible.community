...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_http import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_http import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_http import ArgumentSpec
