...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_config import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_config import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_config import ArgumentSpec
