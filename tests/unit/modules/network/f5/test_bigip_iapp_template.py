...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_iapp_template import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_iapp_template import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_iapp_template import ModuleManager
