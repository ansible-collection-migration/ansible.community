...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_ike_peer import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_ike_peer import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_ike_peer import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_ike_peer import ArgumentSpec
