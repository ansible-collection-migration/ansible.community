...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_snmp_trap import V2Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_snmp_trap import V1Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_snmp_trap import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_snmp_trap import V2Manager
    from ansible_collections.ansible.community.plugins.modules.bigip_snmp_trap import V1Manager
    from ansible_collections.ansible.community.plugins.modules.bigip_snmp_trap import ArgumentSpec

    # Ansible 2.8 imports
    from ansible_collections.ansible.community.tests.unit.compat import unittest
    from ansible_collections.ansible.community.tests.unit.compat.mock import Mock
    from ansible_collections.ansible.community.tests.unit.compat.mock import patch
    from ansible_collections.ansible.community.tests.unit.compat.mock import DEFAULT
