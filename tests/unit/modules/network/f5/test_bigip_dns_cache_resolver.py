...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_dns_cache_resolver import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_dns_cache_resolver import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_dns_cache_resolver import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_dns_cache_resolver import ArgumentSpec
