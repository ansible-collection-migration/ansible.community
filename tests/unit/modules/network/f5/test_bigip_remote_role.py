...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_role import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_role import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_role import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_role import ArgumentSpec
