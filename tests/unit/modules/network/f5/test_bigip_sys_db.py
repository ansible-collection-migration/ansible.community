...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_sys_db import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_sys_db import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_sys_db import ArgumentSpec
