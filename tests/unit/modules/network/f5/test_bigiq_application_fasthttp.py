...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp.bigiq_version')
            self.p2 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp.ModuleParameters.template_reference')
            self.p3 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp.ModuleParameters.ssg_reference')
            self.p4 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_fasthttp.ModuleParameters.default_device_reference')
