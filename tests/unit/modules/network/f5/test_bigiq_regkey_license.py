...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_license import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_license import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_license import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_license import ArgumentSpec
