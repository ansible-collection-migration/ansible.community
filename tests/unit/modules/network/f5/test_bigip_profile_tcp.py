...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_tcp import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_tcp import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_tcp import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_tcp import ArgumentSpec
