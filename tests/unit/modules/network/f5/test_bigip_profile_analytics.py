...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_analytics import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_analytics import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_analytics import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_analytics import ArgumentSpec
