...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_virtual_server import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_virtual_server import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_virtual_server import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_virtual_server import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_gtm_virtual_server.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
