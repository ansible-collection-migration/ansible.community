...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_device_httpd import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_httpd import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_device_httpd import ArgumentSpec
