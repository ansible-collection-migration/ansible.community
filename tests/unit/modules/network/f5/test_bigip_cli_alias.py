...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_cli_alias import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_cli_alias import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_cli_alias import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_cli_alias import ArgumentSpec
