...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_management_route import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_management_route import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_management_route import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_management_route import ArgumentSpec
