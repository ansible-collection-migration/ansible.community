...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_http_compression import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_http_compression import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_http_compression import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_http_compression import ArgumentSpec
