...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_asm_policy_server_technology import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_asm_policy_server_technology import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_asm_policy_server_technology import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_asm_policy_server_technology.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
