...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_fastl4 import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_fastl4 import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_fastl4 import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_fastl4 import ArgumentSpec
