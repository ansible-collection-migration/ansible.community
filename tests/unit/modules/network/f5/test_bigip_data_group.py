...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_data_group import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_data_group import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_data_group import ExternalManager
    from ansible_collections.ansible.community.plugins.modules.bigip_data_group import InternalManager
    from ansible_collections.ansible.community.plugins.modules.bigip_data_group import ArgumentSpec
