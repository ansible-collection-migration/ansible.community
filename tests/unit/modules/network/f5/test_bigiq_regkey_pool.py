...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_pool import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_pool import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_pool import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigiq_regkey_pool import ArgumentSpec
