...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_ipsec_policy import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_ipsec_policy import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_ipsec_policy import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_ipsec_policy import ArgumentSpec
