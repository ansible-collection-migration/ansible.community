...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigiq_application_http import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_application_http import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigiq_application_http import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_http.bigiq_version')
            self.p2 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_http.ModuleParameters.template_reference')
            self.p3 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_http.ModuleParameters.ssg_reference')
            self.p4 = patch('ansible_collections.ansible.community.plugins.modules.bigiq_application_http.ModuleParameters.default_device_reference')
