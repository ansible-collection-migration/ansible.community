...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_provision import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_provision import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_provision import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_provision import ApiParameters
...
class TestManager(unittest.TestCase):
    ...
    def test_provision_all_modules(self, *args):
        ...
        for module in modules:
            ...
            with patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.fail_json') as mo:
                AnsibleModule(
                    argument_spec=self.spec.argument_spec,
                    supports_check_mode=self.spec.supports_check_mode,
                    mutually_exclusive=self.spec.mutually_exclusive
