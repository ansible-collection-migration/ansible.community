...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_udp import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_udp import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_udp import ArgumentSpec
