...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_pool_member import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_pool_member import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_pool_member import NodeApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_pool_member import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_pool_member import ArgumentSpec
