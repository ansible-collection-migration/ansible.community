...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_ssl_key import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_ssl_key import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_ssl_key import ModuleManager
