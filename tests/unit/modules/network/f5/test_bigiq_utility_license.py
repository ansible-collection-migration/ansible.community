...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigiq_utility_license import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_utility_license import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigiq_utility_license import ArgumentSpec
