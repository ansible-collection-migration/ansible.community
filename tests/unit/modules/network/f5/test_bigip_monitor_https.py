...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_https import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_https import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_monitor_https import ArgumentSpec
