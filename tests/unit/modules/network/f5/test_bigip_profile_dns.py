...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_dns import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_dns import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_dns import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_profile_dns import ArgumentSpec
