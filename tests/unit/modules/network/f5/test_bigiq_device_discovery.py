...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigiq_device_discovery import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_device_discovery import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigiq_device_discovery import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigiq_device_discovery import ArgumentSpec
