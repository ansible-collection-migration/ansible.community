...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_wait import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_wait import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_wait import ArgumentSpec
