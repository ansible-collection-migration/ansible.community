...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_datacenter import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_datacenter import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_datacenter import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_gtm_datacenter import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_gtm_datacenter.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
