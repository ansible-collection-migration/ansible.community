...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_imish_config import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_imish_config import ArgumentSpec
