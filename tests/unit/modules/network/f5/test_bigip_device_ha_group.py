...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_device_ha_group import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_ha_group import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_device_ha_group import ArgumentSpec
...
class TestParameters(unittest.TestCase):
    def test_module_parameters_v13(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_device_ha_group.tmos_version')
            self.m1 = self.p1.start()
            self.m1.return_value = '13.1.0'
