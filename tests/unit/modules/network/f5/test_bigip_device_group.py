...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_device_group import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_group import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_group import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_device_group import ArgumentSpec
