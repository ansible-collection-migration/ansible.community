...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_syslog import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_syslog import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_remote_syslog import ArgumentSpec
