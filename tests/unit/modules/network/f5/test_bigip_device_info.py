...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_device_info import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_device_info import VirtualAddressesFactManager
    from ansible_collections.ansible.community.plugins.modules.bigip_device_info import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_device_info import ModuleManager
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.ansible.community.plugins.modules.bigip_device_info.modules_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = ['ltm', 'gtm', 'asm']
