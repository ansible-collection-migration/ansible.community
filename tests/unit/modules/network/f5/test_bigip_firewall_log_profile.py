...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_log_profile import ApiParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_log_profile import ModuleParameters
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_log_profile import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_firewall_log_profile import ArgumentSpec
