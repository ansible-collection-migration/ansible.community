...
try:
    ...
    from ansible_collections.ansible.community.plugins.modules.bigip_user import Parameters
    from ansible_collections.ansible.community.plugins.modules.bigip_user import ModuleManager
    from ansible_collections.ansible.community.plugins.modules.bigip_user import ArgumentSpec
    from ansible_collections.ansible.community.plugins.modules.bigip_user import UnpartitionedManager
    from ansible_collections.ansible.community.plugins.modules.bigip_user import PartitionedManager
