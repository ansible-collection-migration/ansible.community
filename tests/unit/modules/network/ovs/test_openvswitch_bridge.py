...
from ansible_collections.ansible.community.plugins.modules import openvswitch_bridge
...
class TestOpenVSwitchBridgeModule(TestOpenVSwitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_command = (
            patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.run_command'))
