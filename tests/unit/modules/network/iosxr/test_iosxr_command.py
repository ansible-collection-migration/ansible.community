...
from ansible_collections.ansible.community.plugins.modules import iosxr_command
...
class TestIosxrCommandModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.iosxr_command.run_commands')
