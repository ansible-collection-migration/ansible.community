...
from ansible_collections.ansible.community.plugins.modules import cnos_facts
...
class TestCnosFacts(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.ansible.community.plugins.modules.cnos_facts.run_commands')
