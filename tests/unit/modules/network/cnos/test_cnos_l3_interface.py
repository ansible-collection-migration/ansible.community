...
from ansible_collections.ansible.community.plugins.modules import cnos_l3_interface
...
class TestCnosL3InterfaceModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.ansible.community.plugins.modules.cnos_l3_interface.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.ansible.community.plugins.modules.cnos_l3_interface.load_config'
        )
        self._patch_is_switchport = patch(
            'ansible_collections.ansible.community.plugins.modules.cnos_l3_interface.is_switchport'
        )
