...
from ansible_collections.ansible.community.plugins.modules import voss_command
...
class TestVossCommandModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.voss_command.run_commands')
