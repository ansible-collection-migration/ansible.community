...
from ansible_collections.ansible.community.plugins.modules import voss_facts
...
class TestVossFactsModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.voss_facts.run_commands')
