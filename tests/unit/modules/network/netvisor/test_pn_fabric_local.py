...
from ansible_collections.ansible.community.plugins.modules import pn_fabric_local
...
class TestFabricLocalModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.ansible.community.plugins.modules.pn_fabric_local.run_cli')
