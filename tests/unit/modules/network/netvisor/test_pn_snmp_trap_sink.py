...
from ansible_collections.ansible.community.plugins.modules import pn_snmp_trap_sink
...
class TestSnmpTrapSinkModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.ansible.community.plugins.modules.pn_snmp_trap_sink.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.ansible.community.plugins.modules.pn_snmp_trap_sink.check_cli')
