...
from ansible_collections.ansible.community.plugins.modules import nxos_vlans
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.config.vlans.vlans import Vlans
...
class TestNxosVlansModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('ansible_collections.ansible.community.plugins.module_utils.network.nxos.config.vlans.vlans.Vlans.edit_config')
        self.edit_config = self.mock_edit_config.start()

        self.mock_get_device_data = patch('ansible_collections.ansible.community.plugins.module_utils.network.nxos.facts.vlans.vlans.VlansFacts.get_device_data')
