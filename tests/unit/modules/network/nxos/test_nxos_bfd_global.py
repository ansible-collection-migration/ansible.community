...
from ansible_collections.ansible.community.plugins.modules import nxos_bfd_global
...
class TestNxosBfdGlobalModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_bfd_global.load_config')
