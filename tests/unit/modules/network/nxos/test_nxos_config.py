...
from ansible_collections.ansible.community.plugins.modules import nxos_config
from ansible_collections.ansible.community.plugins.cliconf.nxos import Cliconf
...
class TestNxosConfigModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_save_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_config.save_config')
        self.save_config = self.mock_save_config.start()

        self.mock_get_connection = patch('ansible_collections.ansible.community.plugins.modules.nxos_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_config.run_commands')
