...
from ansible_collections.ansible.community.plugins.modules import nxos_evpn_vni
...
class TestNxosEvpnVniModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_evpn_vni.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_evpn_vni.get_config')
