...
from ansible_collections.ansible.community.plugins.modules import nxos_telemetry
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.nxos import NxosCmdRef
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.config.telemetry.telemetry import Telemetry
...
import pytest
from ansible_collections.ansible.community.plugins.module_utils.network.nxos.nxos import nxosCmdRef_import_check
...
class TestNxosTelemetryModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_FACT_LEGACY_SUBSETS = patch('ansible_collections.ansible.community.plugins.module_utils.network.nxos.facts.facts.FACT_LEGACY_SUBSETS')
        self.FACT_LEGACY_SUBSETS = self.mock_FACT_LEGACY_SUBSETS.start()

        self.mock_get_resource_connection_config = patch('ansible_collections.ansible.community.plugins.module_utils.network.common.cfg.base.get_resource_connection')
        self.get_resource_connection_config = self.mock_get_resource_connection_config.start()

        self.mock_get_resource_connection_facts = patch('ansible_collections.ansible.community.plugins.module_utils.network.common.facts.facts.get_resource_connection')
        self.get_resource_connection_facts = self.mock_get_resource_connection_facts.start()

        self.mock_edit_config = patch('ansible_collections.ansible.community.plugins.module_utils.network.nxos.config.telemetry.telemetry.Telemetry.edit_config')
        self.edit_config = self.mock_edit_config.start()

        self.mock_execute_show_command = patch('ansible_collections.ansible.community.plugins.module_utils.network.nxos.nxos.NxosCmdRef.execute_show_command')
        self.execute_show_command = self.mock_execute_show_command.start()

        self.mock_get_platform_shortname = patch('ansible_collections.ansible.community.plugins.module_utils.network.nxos.nxos.NxosCmdRef.get_platform_shortname')
