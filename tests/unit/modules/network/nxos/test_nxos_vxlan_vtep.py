...
from ansible_collections.ansible.community.plugins.modules import nxos_vxlan_vtep
...
class TestNxosVxlanVtepVniModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_vxlan_vtep.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_vxlan_vtep.get_config')
