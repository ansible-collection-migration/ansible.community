...
from ansible_collections.ansible.community.plugins.modules import nxos_banner
...
class TestNxosBannerModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_banner.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_banner.load_config')
