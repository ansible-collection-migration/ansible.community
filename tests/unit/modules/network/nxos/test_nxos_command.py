...
from ansible_collections.ansible.community.plugins.modules import nxos_command
...
class TestNxosCommandModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_command.run_commands')
