...
from ansible_collections.ansible.community.plugins.modules import nxos_interface_ospf
...
class TestNxosInterfaceOspfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_interface_ospf.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_interface_ospf.load_config')
