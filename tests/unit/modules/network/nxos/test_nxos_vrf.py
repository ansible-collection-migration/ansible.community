...
from ansible_collections.ansible.community.plugins.modules import nxos_vrf
...
class TestNxosVrfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_vrf.run_commands')
