...
from ansible_collections.ansible.community.plugins.modules import nxos_pim_rp_address
...
class TestNxosPimRpAddressModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim_rp_address.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim_rp_address.get_config')
