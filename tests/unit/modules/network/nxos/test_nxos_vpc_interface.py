...
from ansible_collections.ansible.community.plugins.modules import nxos_vpc_interface
...
class TestNxosVpcModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_vpc_interface.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_vpc_interface.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_vpc_interface.run_commands')
