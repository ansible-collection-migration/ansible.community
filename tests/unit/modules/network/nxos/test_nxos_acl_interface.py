...
from ansible_collections.ansible.community.plugins.modules import nxos_acl_interface
...
class TestNxosAclInterfaceModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_acl_interface.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_acl_interface.load_config')
