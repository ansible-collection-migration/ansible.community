...
from ansible_collections.ansible.community.plugins.modules import nxos_feature
...
class TestNxosFeatureModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_feature.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_feature.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_capabilities = patch('ansible_collections.ansible.community.plugins.modules.nxos_feature.get_capabilities')
