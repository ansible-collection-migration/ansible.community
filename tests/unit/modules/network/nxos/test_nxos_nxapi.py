...
from ansible_collections.ansible.community.plugins.modules import nxos_nxapi
...
class TestNxosNxapiModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_nxapi.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_nxapi.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_capabilities = patch('ansible_collections.ansible.community.plugins.modules.nxos_nxapi.get_capabilities')
