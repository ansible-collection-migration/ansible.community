...
from ansible_collections.ansible.community.plugins.modules import nxos_vsan
from ansible_collections.ansible.community.plugins.modules.nxos_vsan import GetVsanInfoFromSwitch
...
class TestNxosVsanModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        module_path = 'ansible_collections.ansible.community.plugins.modules.nxos_vsan.'
