...
from ansible_collections.ansible.community.plugins.modules import nxos_devicealias
from ansible_collections.ansible.community.plugins.modules.nxos_devicealias import showDeviceAliasStatus
from ansible_collections.ansible.community.plugins.modules.nxos_devicealias import showDeviceAliasDatabase
...
class TestNxosDeviceAliasModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        module_path = 'ansible_collections.ansible.community.plugins.modules.nxos_devicealias.'
