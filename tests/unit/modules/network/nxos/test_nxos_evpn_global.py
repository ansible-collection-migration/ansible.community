...
from ansible_collections.ansible.community.plugins.modules import nxos_evpn_global
...
class TestNxosEvpnGlobalModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_evpn_global.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_evpn_global.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_capabilities = patch('ansible_collections.ansible.community.plugins.modules.nxos_evpn_global.get_capabilities')
