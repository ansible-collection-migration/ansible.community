...
from ansible_collections.ansible.community.plugins.modules import nxos_ospf_vrf
...
class TestNxosOspfVrfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_ospf_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_ospf_vrf.get_config')
