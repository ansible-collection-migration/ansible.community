...
from ansible_collections.ansible.community.plugins.modules import nxos_pim_interface
...
class TestNxosPimInterfaceBfdModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_interface_mode = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim_interface.get_interface_mode')
        self.get_interface_mode = self.mock_get_interface_mode.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim_interface.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim_interface.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim_interface.run_commands')
