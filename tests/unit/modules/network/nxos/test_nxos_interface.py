...
from ansible_collections.ansible.community.plugins.modules import _nxos_interface
...
class TestNxosInterfaceModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules._nxos_interface.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules._nxos_interface.load_config')
