...
from ansible_collections.ansible.community.plugins.modules import nxos_overlay_global
...
class TestNxosOverlayGlobalModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_overlay_global.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_overlay_global.get_config')
