...
from ansible_collections.ansible.community.plugins.modules import _nxos_l3_interface
...
class TestNxosL3InterfaceModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules._nxos_l3_interface.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules._nxos_l3_interface.get_config')
