...
from ansible_collections.ansible.community.plugins.modules import nxos_pim
...
class TestNxosPimModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.nxos_pim.load_config')
