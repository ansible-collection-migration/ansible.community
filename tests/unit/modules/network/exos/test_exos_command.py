...
from ansible_collections.ansible.community.plugins.modules import exos_command
...
class TestExosCommandModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.exos_command.run_commands')
