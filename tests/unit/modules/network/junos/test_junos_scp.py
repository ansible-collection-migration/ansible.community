...
from ansible_collections.ansible.community.plugins.modules import junos_scp
...
class TestJunosScpModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_device = patch('ansible_collections.ansible.community.plugins.modules.junos_scp.get_device')
        self.get_device = self.mock_get_device.start()

        self.mock_scp = patch('ansible_collections.ansible.community.plugins.modules.junos_scp.SCP')
