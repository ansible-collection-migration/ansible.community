...
from ansible_collections.ansible.community.plugins.modules import junos_ping
...
class TestJunosPingModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_connection = patch('ansible_collections.ansible.community.plugins.modules.junos_ping.get_connection')
