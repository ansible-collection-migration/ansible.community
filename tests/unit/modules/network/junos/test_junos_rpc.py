...
from ansible_collections.ansible.community.plugins.modules import junos_rpc
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_rpc = patch('ansible_collections.ansible.community.plugins.modules.junos_rpc.exec_rpc')
