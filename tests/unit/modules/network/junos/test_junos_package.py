...
from ansible_collections.ansible.community.plugins.modules import junos_package
...
class TestJunosPackageModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_device = patch('ansible_collections.ansible.community.plugins.modules.junos_package.get_device')
