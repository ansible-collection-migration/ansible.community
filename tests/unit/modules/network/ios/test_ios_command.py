...
from ansible_collections.ansible.community.plugins.modules import ios_command
...
class TestIosCommandModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.ios_command.run_commands')
