...
from ansible_collections.ansible.community.plugins.modules import ios_ping
...
class TestIosPingModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.ios_ping.run_commands')
