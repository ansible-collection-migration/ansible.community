...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_dnsfilter_domain_filter
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_dnsfilter_domain_filter.Connection')
