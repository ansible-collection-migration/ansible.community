...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_report_dataset
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_report_dataset.Connection')
