...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_endpoint_control_client
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_endpoint_control_client.Connection')
