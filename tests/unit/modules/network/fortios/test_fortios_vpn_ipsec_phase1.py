...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_vpn_ipsec_phase1
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_vpn_ipsec_phase1.Connection')
