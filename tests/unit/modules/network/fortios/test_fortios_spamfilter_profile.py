...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_spamfilter_profile
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_spamfilter_profile.Connection')
