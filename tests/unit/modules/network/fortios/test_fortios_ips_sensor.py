...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_ips_sensor
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_ips_sensor.Connection')
