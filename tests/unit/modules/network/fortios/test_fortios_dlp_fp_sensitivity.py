...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_dlp_fp_sensitivity
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_dlp_fp_sensitivity.Connection')
