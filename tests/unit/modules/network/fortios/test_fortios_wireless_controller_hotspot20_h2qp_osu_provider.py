...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_wireless_controller_hotspot20_h2qp_osu_provider
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_wireless_controller_hotspot20_h2qp_osu_provider.Connection')
