...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_vpn_ssl_web_realm
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_vpn_ssl_web_realm.Connection')
