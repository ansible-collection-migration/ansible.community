...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_endpoint_control_forticlient_registration_sync
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_endpoint_control_forticlient_registration_sync.Connection')
