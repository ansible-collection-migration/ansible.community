...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_router_access_list
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_router_access_list.Connection')
