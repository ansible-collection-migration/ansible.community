...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_wireless_controller_hotspot20_anqp_3gpp_cellular
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_wireless_controller_hotspot20_anqp_3gpp_cellular.Connection')
