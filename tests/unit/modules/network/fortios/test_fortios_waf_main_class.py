...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_waf_main_class
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_waf_main_class.Connection')
