...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_firewall_central_snat_map
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_firewall_central_snat_map.Connection')
