...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_switch_controller_igmp_snooping
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_switch_controller_igmp_snooping.Connection')
