...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_icap_server
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_icap_server.Connection')
