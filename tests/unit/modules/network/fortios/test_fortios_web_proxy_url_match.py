...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_web_proxy_url_match
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_web_proxy_url_match.Connection')
