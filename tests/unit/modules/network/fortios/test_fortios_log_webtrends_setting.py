...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_log_webtrends_setting
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_log_webtrends_setting.Connection')
