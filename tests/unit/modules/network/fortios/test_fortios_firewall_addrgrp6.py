...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_firewall_addrgrp6
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_firewall_addrgrp6.Connection')
