...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_extender_controller_extender
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_extender_controller_extender.Connection')
