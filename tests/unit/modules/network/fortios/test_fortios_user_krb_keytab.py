...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_user_krb_keytab
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_user_krb_keytab.Connection')
