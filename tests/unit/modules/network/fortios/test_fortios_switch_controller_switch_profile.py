...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_switch_controller_switch_profile
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_switch_controller_switch_profile.Connection')
