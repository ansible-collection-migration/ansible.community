...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_system_cluster_sync
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_system_cluster_sync.Connection')
