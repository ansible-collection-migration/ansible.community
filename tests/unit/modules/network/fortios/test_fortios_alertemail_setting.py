...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_alertemail_setting
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_alertemail_setting.Connection')
