...
try:
    from ansible_collections.ansible.community.plugins.modules import fortios_wanopt_cache_service
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fortios_wanopt_cache_service.Connection')
