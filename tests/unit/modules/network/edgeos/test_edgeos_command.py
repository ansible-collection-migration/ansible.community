...
from ansible_collections.ansible.community.plugins.modules import edgeos_command
...
class TestEdgeosCommandModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.edgeos_command.run_commands')
