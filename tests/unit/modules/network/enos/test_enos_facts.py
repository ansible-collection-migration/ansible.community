...
from ansible_collections.ansible.community.plugins.modules import enos_facts
...
class TestEnosFacts(TestEnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.ansible.community.plugins.modules.enos_facts.run_commands')
