...
from ansible_collections.ansible.community.plugins.modules import eos_command
...
class TestEosCommandModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.eos_command.run_commands')
