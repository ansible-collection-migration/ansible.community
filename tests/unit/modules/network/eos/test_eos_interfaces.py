...
from ansible_collections.ansible.community.plugins.modules import eos_interfaces
...
class TestEosInterfacesModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch('ansible_collections.ansible.community.plugins.module_utils.network.eos.facts.interfaces.interfaces.InterfacesFacts.get_device_data')
