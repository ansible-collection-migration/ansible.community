...
from ansible_collections.ansible.community.plugins.modules import eos_banner
...
class TestEosBannerModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.eos_banner.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.eos_banner.load_config')
