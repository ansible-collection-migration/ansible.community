...
from ansible_collections.ansible.community.plugins.modules import eos_logging
...
class TestEosLoggingModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.eos_logging.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.eos_logging.load_config')
