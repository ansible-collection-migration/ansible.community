...
from ansible_collections.ansible.community.plugins.modules import eos_user
...
class TestEosUserModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.community.plugins.modules.eos_user.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.community.plugins.modules.eos_user.load_config')
