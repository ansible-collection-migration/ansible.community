...
from ansible_collections.ansible.community.plugins.module_utils.network.eos.providers.cli.config.bgp.process import Provider
from ansible_collections.ansible.community.plugins.modules import eos_bgp
