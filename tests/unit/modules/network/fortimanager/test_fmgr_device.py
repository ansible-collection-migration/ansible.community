...
try:
    from ansible_collections.ansible.community.plugins.modules import fmgr_device
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fmgr_device.Connection')
    return connection_class_mock
