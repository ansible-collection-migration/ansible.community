...
try:
    from ansible_collections.ansible.community.plugins.modules import fmgr_device_group
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fmgr_device_group.Connection')
    return connection_class_mock
