...
try:
    from ansible_collections.ansible.community.plugins.modules import fmgr_fwobj_vip
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fmgr_fwobj_vip.Connection')
    return connection_class_mock
