...
try:
    from ansible_collections.ansible.community.plugins.modules import fmgr_secprof_spam
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fmgr_secprof_spam.Connection')
    return connection_class_mock
