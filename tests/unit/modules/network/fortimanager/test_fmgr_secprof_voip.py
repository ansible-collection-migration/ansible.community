...
try:
    from ansible_collections.ansible.community.plugins.modules import fmgr_secprof_voip
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.community.plugins.modules.fmgr_secprof_voip.Connection')
    return connection_class_mock
