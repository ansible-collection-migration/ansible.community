...
from ansible_collections.ansible.community.plugins.modules import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.nos_facts.run_commands')
