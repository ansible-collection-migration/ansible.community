...
from ansible_collections.ansible.community.plugins.modules import dellos9_command
...
class TestDellos9CommandModule(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.community.plugins.modules.dellos9_command.run_commands')
