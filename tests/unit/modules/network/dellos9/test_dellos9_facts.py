...
from ansible_collections.ansible.community.plugins.modules import dellos9_facts
...
class TestDellos9Facts(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.ansible.community.plugins.modules.dellos9_facts.run_commands')
