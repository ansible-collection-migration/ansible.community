...
import ansible_collections.ansible.community.tests.unit.compat.unittest as unittest
...
if sys.version_info[:2] != (2, 6):
    from ansible_collections.ansible.community.plugins.modules.cs_traffic_type import AnsibleCloudStackTrafficType, setup_module_object
    from ansible_collections.ansible.community.plugins.module_utils.cloudstack import HAS_LIB_CS
    if not HAS_LIB_CS:
