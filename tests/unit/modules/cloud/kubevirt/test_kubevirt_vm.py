...
from ansible_collections.ansible.community.plugins.module_utils.kubevirt import KubeVirtRawModule
from ansible_collections.ansible.community.plugins.modules import kubevirt_vm as mymodule
