...
from ansible_collections.ansible.community.plugins.module_utils.aws.core import HAS_BOTO3
...
from ansible_collections.ansible.community.plugins.modules import lambda_policy
from ansible_collections.ansible.community.plugins.modules.lambda_policy import setup_module_object
try:
