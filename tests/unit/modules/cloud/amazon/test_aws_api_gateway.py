...
import ansible_collections.ansible.community.plugins.modules.aws_api_gateway as agw
from ansible_collections.ansible.community.plugins.module_utils.aws import core
