...
from ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_FileSystems \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('ansible_collections.ansible.community.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.ansible.community.plugins.module_utils.netapp.AwsCvsRestAPI.post')
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystem')
    @patch('ansible_collections.ansible.community.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.ansible.community.plugins.module_utils.netapp.AwsCvsRestAPI.delete')
