...
from ansible_collections.ansible.community.plugins.modules import route53_zone
...
@patch('ansible_collections.ansible.community.plugins.module_utils.aws.core.HAS_BOTO3', new=True)
