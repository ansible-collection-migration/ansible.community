...
from ansible_collections.ansible.community.plugins.modules import ec2_vpc_vpn
from ansible_collections.ansible.community.plugins.module_utils.ec2 import get_aws_connection_info, boto3_conn, boto3_tag_list_to_ansible_dict
