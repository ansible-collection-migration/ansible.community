...
from ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_snapshots \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getSnapshotId')
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getfilesystemId')
