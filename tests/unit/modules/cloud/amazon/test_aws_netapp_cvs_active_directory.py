...
from ansible_collections.ansible.community.plugins.module_utils.netapp import AwsCvsRestAPI
from ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_active_directory \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectoryId')
    @patch('ansible_collections.ansible.community.plugins.modules.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectory')
