...
from ansible_collections.ansible.community.plugins.modules.s3_bucket_notification import AmazonBucket, Config
from ansible_collections.ansible.community.plugins.modules import s3_bucket_notification
try:
...
class TestModule(ModuleTestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.modules.s3_bucket_notification.AnsibleAWSModule.client')
