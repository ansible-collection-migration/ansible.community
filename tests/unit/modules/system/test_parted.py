...
from ansible_collections.ansible.community.plugins.modules import parted as parted_module
from ansible_collections.ansible.community.plugins.modules.parted import parse_partition_info
...
class TestParted(ModuleTestCase):
    def setUp(self):
        ...
        self.mock_check_parted_label = (patch('ansible_collections.ansible.community.plugins.modules.parted.check_parted_label', return_value=False))
        self.check_parted_label = self.mock_check_parted_label.start()

        self.mock_parted = (patch('ansible_collections.ansible.community.plugins.modules.parted.parted'))
        self.parted = self.mock_parted.start()

        self.mock_run_command = (patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.run_command'))
        self.run_command = self.mock_run_command.start()

        self.mock_get_bin_path = (patch('ansible_collections.ansible.community.plugins.module_utils.basic.AnsibleModule.get_bin_path'))
    ...
    def test_partition_already_exists(self):
        ...
        with patch('ansible_collections.ansible.community.plugins.modules.parted.get_device_info', return_value=parted_dict1):
    ...
    def test_create_label_gpt(self):
        ...
        with patch('ansible_collections.ansible.community.plugins.modules.parted.get_device_info', return_value=parted_dict2):
