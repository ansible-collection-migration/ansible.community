...
from ansible_collections.ansible.community.plugins.modules import rhn_register
...
def test_systemid_with_requirements(capfd, mocker, patch_rhn):
    ...
    mocker.patch('ansible_collections.ansible.community.plugins.modules.rhn_register.open', mock_open(read_data=SYSTEMID), create=True)
