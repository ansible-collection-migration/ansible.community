...
from ansible_collections.ansible.community.plugins.module_utils.urls import ConnectionError, SSLValidationError
from ansible.module_utils.six.moves.urllib.error import HTTPError, URLError
from ansible.module_utils import six
from ansible_collections.ansible.community.plugins.lookup.manifold import ManifoldApiClient, LookupModule, ApiError
import json
...
class TestManifoldApiClient(unittest.TestCase):
    @patch('ansible_collections.ansible.community.plugins.lookup.manifold.open_url')
...
class TestLookupModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.manifold.display')
    @patch('ansible_collections.ansible.community.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.manifold.os.getenv')
    @patch('ansible_collections.ansible.community.plugins.lookup.manifold.ManifoldApiClient')
