...
from ansible_collections.ansible.community.plugins.lookup.lastpass import LookupModule, LPass, LPassException
...
class TestLastpassPlugin(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.lastpass.LPass', new=MockLPass)
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.lastpass.LPass', LoggedOutMockLPass)
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.lastpass.LPass', DisconnectedMockLPass)
