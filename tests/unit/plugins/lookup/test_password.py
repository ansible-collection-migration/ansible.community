...
from ansible_collections.ansible.community.plugins.lookup import password
...
class TestLookupModuleWithoutPasslib(BaseTestLookupModule):
    ...
    @patch('ansible_collections.ansible.community.plugins.lookup.password._write_password_file')
