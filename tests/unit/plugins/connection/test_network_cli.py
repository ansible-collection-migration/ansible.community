...
class TestConnectionClass(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.connection.network_cli.terminal_loader')
    @patch('ansible_collections.ansible.community.plugins.connection.paramiko_ssh.Connection._connect')
    ...
    @patch('ansible_collections.ansible.community.plugins.connection.paramiko_ssh.Connection.close')
    ...
    @patch('ansible_collections.ansible.community.plugins.connection.network_cli.Connection._get_terminal_std_re')
    @patch('ansible_collections.ansible.community.plugins.connection.network_cli.Connection._connect')
