...
if PY3:
    with patch('builtins.__import__', side_effect=import_mock):
        from ansible_collections.ansible.community.plugins.connection import netconf
...
class TestNetconfConnectionClass(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.connection.netconf.netconf_loader')
