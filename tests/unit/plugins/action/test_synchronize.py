...
from ansible_collections.ansible.community.plugins.action.synchronize import ActionModule
...
class TestSynchronizeAction(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.community.plugins.action.synchronize.connection_loader', FakePluginLoader)
    def test_basic(self):
        x = SynchronizeTester()
